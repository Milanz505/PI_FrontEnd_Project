    ...
    <main className='bg-gradient-to-r from-white via-zinc-100 to-zinc-600 w-full h-screen'>
      ...
      <div className="flex pl-48 p-7 space-x-3 items-start gap-16 mt-20">
        ...
        <form className="flex flex-col">
          ...
          <Input type="email"  id="email" className='rounded-full p-1 pr-20 border-[#898888] border outline-none'/>
          <label htmlFor="password" className='mt-5 ml-1'>Senha</label>
          <Input type="password" id="password" className='rounded-full p-1 border-[#898888] border outline-none'/>
        ...
        <form className="flex flex-col">
          ...
          <Input type="text"  id="usuario" className='rounded-full p-1 pr-20 border-[#898888] border outline-none'/>
          <label htmlFor="email" className='mt-5 ml-1'>Email</label>
          <Input type="email"  id="email" className='rounded-full p-1 pr-20 border-[#898888] border outline-none'/>
          <label htmlFor="password" className='mt-5 ml-1'>Senha</label>
          <Input type="password" id="password" className='rounded-full p-1 border-[#898888] border outline-none'/>
          <label htmlFor="passwordconfirm" className='mt-5 ml-1'>Confirmar senha</label>
          <Input type="password" id="passwordconfirm" className='rounded-full p-1 border-[#898888] border outline-none'/>
